...
function prefix_video()
{
	...
	$labels = array(
		'name'               => __('Videos', 'nextstep'),
		'singular_name'      => __('Video', 'nextstep'),
		'add_new'            => _x('Add New Video', 'nextstep', 'nextstep'),
		'add_new_item'       => __('Add New Video', 'nextstep'),
		'edit_item'          => __('Edit Video', 'nextstep'),
		'new_item'           => __('New Video', 'nextstep'),
		'view_item'          => __('View Video', 'nextstep'),
		'search_items'       => __('Search Videos', 'nextstep'),
		'not_found'          => __('No Videos found', 'nextstep'),
		'not_found_in_trash' => __('No Videos found in Trash', 'nextstep'),
		'parent_item_colon'  => __('Parent Video:', 'nextstep'),
		'menu_name'          => __('Videos', 'nextstep'),
	);
